<template>
  <div id="potential">
    ...
    <div class="tips">
      ...
      <div class="content">
        "公共客户"这里将显示当前项目非跟进保护期内的所有客户，在这里你可以
      </div>
      <div class="itemList">
        <div class="item">1、查看所有公共客户的详细资料</div>
        <div class="item">
          2、将公共客户标记为自己的意向客户，进行激活重新跟进
        </div>
        <div class="item">
          3、标记为自己的意向客户后，该客户将会在意向列表显示
        </div>
      </div>
    </div>
    <!-- 列表 -->
          ...
          <div class="itemRight">
            <div class="itemDetail">
              <div class="info">
                ...
                <div class="visit">
                  <span class="visit_times">过保时间</span>
      ...
      <div class="popupContainer">
        <div class="option">
          ...
          >
            ...
            <van-radio class="isChecked" name="2">近7日</van-radio>
        ...
        <div class="option">
          <div class="title">最近跟办人</div>
          <van-radio-group v-model="radio" direction="horizontal">
            <van-radio name="1">在职顾问</van-radio>
            <van-radio name="2">已离职顾问</van-radio>
          </van-radio-group>
        </div>
        <div class="twobtn">
